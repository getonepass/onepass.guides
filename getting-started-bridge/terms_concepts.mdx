---
title: Terms and Concepts in OnePass Bridge
sidebarTitle: Terms and Concepts
description: Learn about the key terms and concepts used in OnePass Bridge to help you navigate and leverage the platform effectively.
keywords: "OnePass Bridge, Terms, Concepts, Verifiable Credential, Verification Flow, Issuer, Holder, Verifier, Digital Wallet, Decentralized Identifier, Trust Framework, TAO, KYC, KYB, Venture Readiness Momentum, SME Status, Data Room"
category: "OPP, Bridge"
theme: 
  toc: true
  timestamp: true
...
# Terms and Concepts in OnePass Bridge
...
The Documents Hub is a centralized repository within OnePass Bridge where users can securely store, organize, and manage important documents and files related to their organization, investments, or fundraising activities. It serves as a secure and accessible storage space for essential documents, enabling users to easily upload, share, and track document access and interactions. The Documents Hub enhances collaboration, transparency, and efficiency by providing a centralized location for managing critical information and materials.
