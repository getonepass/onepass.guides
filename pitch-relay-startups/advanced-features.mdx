...
- **Refine Your Search:** Use filters to narrow down pitches by industry, stage, location, funding range, and more.  
- **Save Time:** Quickly identify startups that align with your investment goals.  

### 2. Deal Flow Management

- **Organize Your Pipeline:** Categorize pitches into stages (e.g., interested, under review, declined).  
- **Track Progress:** Monitor the status of each pitch and your interactions with founders.  

### 3. Collaboration Tools

- **Share Pitches:** Share interesting pitches with your team or co-investors for feedback.  
- **Collaborate in Real-Time:** Use OnePass’s built-in tools to discuss pitches and make investment decisions as a team.  

### 4. Verifiable Credentials

- **Verify Startup Claims:** Use OnePass’s decentralized identity framework to validate key information (e.g., legal identity, financials).  
- **Reduce Risk:** Ensure startups are trustworthy and their claims are accurate.  
