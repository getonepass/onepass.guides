...
description: Learn how to collect and store your verifiable credential securely
keywords: "Verifiable Credentials, Credential Collection, OnePass Credentials, Holder Wallet"
category: "OPP, Bridge, Credentials"
sidebarTitle: Collecting a Credential
asIndexPage: false
theme:
  toc: true
  timestamp: true
...
<Alert className="mt-8" type="info">
  ...
  <AlertDescription>
    Refer to the [Choosing a Wallet](./choosing-wallet.mdx) guide to select a suitable holder wallet for storing your credentials.
  </AlertDescription>
</Alert>
...
<Steps>
### Receive the Credential Notification
...
### Store the Credential in Your Holder Wallet
...
### Open your wallet and navigate to the credentials section

### Confirm that the **new credential appears** in your list of stored credentials

### Check the **credential details** to ensure all information is correct
