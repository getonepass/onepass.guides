...
description: Learn about verifiable credentials, their structure, and real-world applications.
keywords: Verifiable Credentials, Digital Credentials, Decentralized Identity, OnePass Credentials
category: OPP, Bridge, Identity
sidebarTitle: What Are Verifiable Credentials?
asIndexPage: false
theme:
  toc: true
  timestamp: true
