...
Verifying your company’s legal identity on OnePass helps establish trust and credibility, ensuring that your business is recognized as a legitimate entity within the ecosystem. This verification is based on a **Legal Entity Verifiable ID** credential issued by our trusted verification partners.
...
To verify your company’s legal identity, you need to obtain a **Legal Entity Verifiable ID** issued by one of our trusted verification partners.

<Steps>
### Check if You Already Have a Credential

Before starting, check whether your company already holds a **Legal Entity Verifiable ID** issued by one of our verification partners. If you have it, you can proceed to step 4: present and verify it on OnePass.

### Request a Verification Credential

If you do not yet have a **Legal Entity Verifiable ID**, you must request it from one of our verification partners:
...
3. **Once verified**, the partner will issue a **Legal Entity Verifiable ID** credential.

### Present Your Credential on OnePass

Once you have your **Legal Entity Verifiable ID**, follow these steps to complete verification on OnePass:

1. Navigate to **OnePass Workspace Settings** > Verify > **Business Legal Entity Verification**.
2. Click **Present Credential** and select your issued **Legal Entity Verifiable ID**.
3. Scan the QR code or copy the link to use in your Holder Wallet.
4. **Complete the presentation** using your Holder Wallet.
5. OnePass will validate the credential and mark your company as verified.
</Steps>
...
- After successful verification, your company profile will display an <FontAwesomeIcon icon={faBadgeCheck} size="lg" style={{color: "#FFD43B",}} /> **Verified Legal Identity Badge**.
...
**Start your legal entity verification today to enhance your company’s trust and recognition on OnePass!**
