...
- **Verification Process:** Companies must submit relevant company documents for review and approval.
</Steps>
...
- <FontAwesomeIcon icon={faBadgeCheck} size="lg" style={{color: "#6600ff",}} /> **Blue Badge** – Verified Company Domain
- <FontAwesomeIcon icon={faBadgeCheck} size="lg" style={{color: "#33f06c",}} /> **Green Badge** – Verified Contact Email
- <FontAwesomeIcon icon={faBadgeCheck} size="lg" style={{color: "#FFD43B",}} />  **Yellow Badge** – Verified Legal Identity
